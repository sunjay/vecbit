...
/** Generalizes over the fundamental types for use in `vecbit` data structures.
	...
	+ BitOps
{
	...
	///
	/// Within `&SliceBit` and `&mut SliceBit` contexts, the `Access` type
	...
	/// # Safety
	///
	/// This method cannot be called from within an `&SliceBit` context; it may
	...
	/// # Safety
	///
	/// This method cannot be called from within an `&mut SliceBit` context; it
