...
//  `SliceBit::empty` is not benched, because the compiler const-folds it. It
...
//  `SliceBit::empty` call sites. It takes 0ns.

#[bench]
fn element(b: &mut Bencher) {
	b.iter(|| SliceBit::<BigEndian, u8>::from_element(&!0));
	b.iter(|| SliceBit::<LittleEndian, u8>::from_element(&!0));
	b.iter(|| SliceBit::<BigEndian, u16>::from_element(&!0));
	b.iter(|| SliceBit::<LittleEndian, u16>::from_element(&!0));
	b.iter(|| SliceBit::<BigEndian, u32>::from_element(&!0));
	b.iter(|| SliceBit::<LittleEndian, u32>::from_element(&!0));

	#[cfg(target_pointer_width = "64")] {

	b.iter(|| SliceBit::<BigEndian, u64>::from_element(&!0));
	b.iter(|| SliceBit::<LittleEndian, u64>::from_element(&!0));
...
fn slice(b: &mut Bencher) {
	b.iter(|| SliceBit::<BigEndian, u8>::from_slice(&[0, 1, !0 - 1, !0][..]));
	b.iter(|| SliceBit::<LittleEndian, u8>::from_slice(&[0, 1, !0 - 1, !0][..]));
	b.iter(|| SliceBit::<BigEndian, u16>::from_slice(&[0, 1, !0 - 1, !0][..]));
	b.iter(|| SliceBit::<LittleEndian, u16>::from_slice(&[0, 1, !0 - 1, !0][..]));
	b.iter(|| SliceBit::<BigEndian, u32>::from_slice(&[0, 1, !0 - 1, !0][..]));
	b.iter(|| SliceBit::<LittleEndian, u32>::from_slice(&[0, 1, !0 - 1, !0][..]));

	#[cfg(target_pointer_width = "64")] {

	b.iter(|| SliceBit::<BigEndian, u64>::from_slice(&[0, 1, !0 - 1, !0][..]));
	b.iter(|| SliceBit::<LittleEndian, u64>::from_slice(&[0, 1, !0 - 1, !0][..]));
